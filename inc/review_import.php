...
class SWREI_reviewimport {
	
	public function __construct() {
		
	}
	public static function SWREI_review_importer($temp_name){	
		...
		return SWREI_reviewimport::SWREI_import_reviews($csv);	
	}
		
	public function SWREI_import_reviews($reviewData){
